document.addEventListener('DOMContentLoaded', function() {
  ...
  if (navbar) {
    ...
    function updateNavbar() {
      ...
      var isRTL = document.dir === 'rtl' || getComputedStyle(document.body).direction === 'rtl';
  ...
  if (animatedElements.length > 0) {
    function checkVisibility() {
      ...
      animatedElements.forEach(function(el) {
        ...
        var isVisible = rect.top <= windowHeight - triggerOffset && rect.bottom >= 0;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4d21dcf7-0de3-4242-ae2d-ff16233bb963',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4d21dcf7-0de3-4242-ae2d-ff16233bb963';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4d21dcf7-0de3-4242-ae2d-ff16233bb963';
